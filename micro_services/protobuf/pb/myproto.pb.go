...
type Student struct {
	...
	Age   int32   `protobuf:"varint,1,opt,name=age,proto3" json:"age,omitempty"` //可以不从1开始，但是不能重复, 不能使用19000-19999,是protobuf自留的
...
var file_myproto_proto_rawDesc = []byte{
	...
	0x75, 0x64, 0x65, 0x6e, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06,
